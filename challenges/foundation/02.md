...
- [ ] If running in a Codespace, install the webpack packages

```console
npx expo install react-native-web react-dom @expo/metro-runtime
```

- [ ] To preview the app run the start command:
  - [ ]  If running locally, scan the QR Code with your phone.
  - [ ]  If running a Codespace, select "Open" on the pop-up.
